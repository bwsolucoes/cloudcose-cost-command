...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-cloudcose-light to-white font-inter">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              <Cloud className="h-8 w-8 text-cloudcose-purple" />
              <span className="text-2xl font-bold text-cloudcose-dark-blue">CloudCose</span>
            </div>
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#funcionalidades" className="text-gray-700 hover:text-cloudcose-purple transition-colors">Funcionalidades</a>
              <a href="#beneficios" className="text-gray-700 hover:text-cloudcose-purple transition-colors">Benefícios</a>
              <a href="#contato" className="text-gray-700 hover:text-cloudcose-purple transition-colors">Contato</a>
              <Button className="bg-cloudcose-purple hover:bg-cloudcose-purple/90">
                Solicitar Demo
              </Button>
            </nav>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              <h1 className="text-4xl md:text-6xl font-bold text-cloudcose-dark-blue leading-tight mb-6">
                Transforme sua gestão de custos na 
                <span className="text-cloudcose-purple"> Cloud</span> com transparência, controle e eficiência
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Visibilidade centralizada. Economia automática. Decisões orientadas por dados.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-cloudcose-purple hover:bg-cloudcose-purple/90 text-white px-8 py-4 text-lg">
                  Solicitar Demonstração
                </Button>
                <Button size="lg" variant="outline" className="border-cloudcose-blue text-cloudcose-blue hover:bg-cloudcose-blue hover:text-white px-8 py-4 text-lg">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-blue-50 p-3 rounded-lg text-center">
                      <div className="text-2xl font-bold text-cloudcose-blue">127</div>
                      <div className="text-xs text-gray-600">Recursos Otimizados</div>
                    </div>
                    <div className="bg-purple-50 p-3 rounded-lg text-center">
                      <div className="text-2xl font-bold text-cloudcose-purple">68%</div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-cloudcose-dark-blue mb-4">
            ...
            {[
              ...
              <Card key={index} className="hover:shadow-xl transition-shadow bg-white border-0 shadow-lg">
                <CardContent className="p-8">
                  <div className="w-16 h-16 bg-gradient-to-r from-cloudcose-purple to-cloudcose-blue rounded-xl flex items-center justify-center mb-6">
                    <beneficio.icon className="h-8 w-8 text-white" />
                  </div>
                  <h3 className="text-xl font-bold text-cloudcose-dark-blue mb-3">{beneficio.title}</h3>
      ...
      <section id="funcionalidades" className="py-20 bg-gradient-to-r from-cloudcose-blue to-cloudcose-dark-blue">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
      ...
      <section className="py-20 bg-gradient-to-r from-cloudcose-purple to-purple-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center mt-1">
                      <Check className="h-4 w-4 text-cloudcose-purple" />
                    </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              <div className="text-center">
                ...
                <div className="text-purple-100 text-lg mb-6">Economia Média</div>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
            ...
            <span className="text-cloudcose-purple"> vantagem competitiva</span>
          </h2>
          <p className="text-xl text-gray-300 mb-10">
            Junte-se a centenas de empresas que já otimizaram seus custos cloud com CloudCose
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Button size="lg" className="bg-cloudcose-purple hover:bg-cloudcose-purple/90 text-white px-10 py-4 text-lg">
              Teste Gratuito
            </Button>
            ...
            <Button size="lg" className="bg-cloudcose-blue hover:bg-cloudcose-blue/90 text-white px-10 py-4 text-lg">
              Entre em Contato
            </Button>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer id="contato" className="bg-cloudcose-dark-blue py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-blue-200">
                Email: <a href="mailto:contact@cloudcose.com" className="text-white hover:text-cloudcose-purple transition-colors">contact@cloudcose.com</a>
              </p>
              <p className="text-blue-200">
                Site: <a href="https://cloudcose.com" className="text-white hover:text-cloudcose-purple transition-colors">cloudcose.com</a>
              </p>
            </div>
            <div>
